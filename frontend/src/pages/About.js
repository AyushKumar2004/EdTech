  ...
  return (
    <div>
      ...
      <section className='bg-richblack-700'>
        <div className='mx-auto relative flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
      ...
      {/* Section 3 */}
      <section>
        <div className='flex flex-col mx-auto max-w-maxContent w-11/12 justify-between gap-10 text-richblack-500'>
            ...
            {/* vission and mision wala parent div */}
            <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                ...
                <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                    ...
                    <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                        ...
                        knowledge thrives in an environment of sharing and dialogue, and we foster this
      ...
      {/* Section 5 */}
      <section className='mx-auto flex flex-col items-center justify-center gap-10 text-white mt-20 w-11/12 max-w-maxContent'>
        <LearningGrid/>
        <ContactFormSection/>
      </section>
