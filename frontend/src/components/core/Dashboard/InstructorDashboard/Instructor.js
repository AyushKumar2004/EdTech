                ...
                <div className='my-4 flex h-[450px] space-x-4'>
                    {
                        totalAmount>0 && totalStudents>0 ? (
                            ...
                            <div className='flex-1 rounded-md bg-richblack-800 p-6'>
                                ...
                                <p className='mt-4 text-xl font-medium text-richblack-50'>Not Enough Data to Vizualize</p>
                            </div>
                        )
                    }
                    <div className='flex min-h-[250px] w-[calc(25%-1rem)]  flex-col rounded-md bg-richblack-800 p-6'>
                ...
                <div className='rounded-md bg-richblack-800 p-6'>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <Link to="/dashboard/my-courses">
                            <p className='text-xs font-bold text-richblack-5'>View all</p>
                        </Link>
                    </div>
