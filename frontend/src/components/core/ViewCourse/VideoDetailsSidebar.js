  ...
  return (
    <>
        <div className='flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800 '>
            <div className='mx-5 flex flex-col item-satrt justify-between gap-2 gap-y-4 border-b border-r-chblack-600 py-5 text-lg font-bold text-richblack-25'>
                                        ...
                                        <div className='transition-[height] duration-500 ease-in-out'>
                                            {
                                                course.subSection.map((topic,index)=>(
                                                    <div
                                                    className={`flex gap-3 px-5 py-2 ${videoBarActive===topic._id?"bg-yellow-200 text-richblack-800 font-semibold":"hover:bg-richblack-900 "}`}
                                                    key={index}
                                                    onClick={()=>{
