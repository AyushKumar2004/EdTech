  ...
  return (
    <>
      ...
      <div className='flex w-11/12 max-w-maxContent items-center justify-between '>
        ...
        <button className='mr-4 md:hidden flex flex-col relative' onClick={()=>{
          setClose(!close);
          ...
          <div className='bg-white w-[100vw] z-[2000] absolute top-10 right-0 translate-x-[10%]'>
          {
            smallDiv && (
              <div className='flex flex-col w-full h-[15vh] text-center'>
                {
                  user && user?.accountType!==ACCOUNT_TYPE.INSTRUCTOR && (
                      <Link to={"/dashboard/cart"} className='relative'>
                          <AiOutlineShoppingCart className="text-2xl text-richblack-100" onClick={()=>{
                              setSmallDiv(!smallDiv)
                              setClose(!close)
                            }} />
                          {
                ...
                }
                {
                    token === null && (
                        <Link to={"/login"}>
                            <button className=' px-[12px] py-[8px] text-richblack-800 ' onClick={()=>{
                              setSmallDiv(!smallDiv)
                              setClose(!close)
                            }}>
                                Login
                ...
                {
                    token !== null && <ProfileDropDown onClick={()=>{
                            setSmallDiv(!smallDiv)
                            setClose(!close)
                          }}/>
                }
